...
% applications.
The objectives of GAIA\footnote{Gaia is an ancient Greek goddess who takes good 
...
migration uses a similar technique as primary-backup. Both techniques are
used to improve computer load balance and consolidating many VMs on fewer 
computers to save datacenter energy. A common problem in the two techniques 
