...
\para{Trusted execution envoriments (TEE)}. 
...
process. By integrating the outcomes of all three objectives, data privacy will 
be effectively preserved against both the computational providers and cloud 
providers.

\para{Data provenance}. TBD. 

% \para{Other aspects of security}. 
