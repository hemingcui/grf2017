...
% 
The second infrastruture type is VM~\cite{amazon:vpc, openstack, esx:osdi02, 
kvm, xen:sosp}. VM abstracts away the heterougous physical computing 
...
prohibitive resources (\eg, CPU and network bandwith) and have weaker 
