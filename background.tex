...
will discuss how concurrency attacks weaken various defense techniques.
...
and led to stack overflows. \S\ref{sec:model} will give two concrete 
examples.

There are two interesting discoveries in our study. First, unlike 
...
broken in. Therefore, studying existing know concurrency are still crucial.
