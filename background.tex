...
Data leakage is a top threat in cloud computing~\cite{top-threats}. 
In a data provider's perspective, there have been severe real-world data 
privacy breaches~\cite{real-breaches} caused by computational providers and 
cloud providers. This proposal aims to preserve the data provider's 
privacy by going two directions. First, we propose two novel complimentary 
...
providers in private clouds. Second, we propose \textbf{Objective 3} (a new 
privacy-preserving compiler) to protect privacy against the (public) cloud 
