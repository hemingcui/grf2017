...
For a query results, low accuracy means bad utility. For instance, a KMeans 
program will return centroids far from the actual ones, because the accuracy 
loss rate is much larger than the training error rate (less than 10\% 
...
created automatic tools~\cite{woodpecker:asplos13,wu:pldi12} to detect various 
new 
security vulnerabilities in widely used real-world software, including data 
