...
TCP/IP layers (a \vv{ping} round-trip takes about 200 \us in a 10Gbps network), 
...
VMs on fewer computers to save energy. It uses a similar technique as 
primary-backup. Despite much effort, both these two approaches consume 
substantial application down time (\eg, 8 seconds in 
