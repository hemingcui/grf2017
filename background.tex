...
% 
The second infrastruture type is VM~\cite{amazon:ec2, openstack, vmware, kvm, 
xen:sosp01}. VM abstracts away the heterougous physical computing resources, 
making computing resources easy to isolate, utilize, and balance loads (\eg, 
