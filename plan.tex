...
data locality (\eg, according to prior arrangements) to execute the call, 
greatly reducing both enclave transitions and data decryption. The call result 
is appended to a return queue of the DAE for process $T$. We expect that DAE 
will achieve resonable performance, data locality, and parallelism.
