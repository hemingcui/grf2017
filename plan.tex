...
can have different sensitivity levels. Data is partitioned into multiple parts 
denoted as $D_1$, ..., $D_n$, while each $D_i$ has a security level of 
$\varepsilon_i$. \textbf{Algorithm 1} adds noise to the query results $O_i$ of 
