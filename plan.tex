...
computers. The leader controller directly returns its computation result to the 
Hadoop application. A standby controller ignores computation results unless it 
...
consumes 3*\vv{V} resources, our VM design reduces this consumption by letting 
