...
\para{Future directions.} We forsee two directions for \tripod's 
...
our scheme requires application developers to manually assign \vv{R} values to 
...
that can automatically analyze an application and assign precise \vv{R} values 
