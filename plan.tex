...
across VMs. Divergent pages and their parent nodes are marked red by 
\textbf{Algorithm 1}.}
        \label{fig:vm-tree}
    \end{minipage}
...
these dirty memory from primary to backup. We also found that only 471 to 983 
of these dirty pages were divergent between two VMs. This preliminary study 
implies that our algorithm can reduce up to 96.7\% transfered pages compared 
to existing primary-backup techniques.
