...
a \paxos protocol for every application. However, this will cause two major 
issues. First, \paxos is notoriously difficult to 
...
\para{Future work}. We will fully implement this new fault-tolerant VM, 
