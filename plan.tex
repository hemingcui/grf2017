...
path slicer to smartly identify the vulnerable ones among the safe ones (\eg, 
some \texttt{strcpy()} functions are safe if they only manipulate memory 
...
trigger concurrency bugs? Addressing these challenges will probably lead to 
