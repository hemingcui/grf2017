...
three years. S1 will develop the concurrency attack model (Objective 1) and 
design the detailed workflow of the detection approach (part of Objective 2). S2 
will implement the detection approach as a software tool (part of Objective 2) 
and build the runtime defense infrastructure (Objective 3). The two students can 
carry on many tasks of these objectives in parallel. The two students will also 
conduct a wide range study on real-world multithreaded programs to evaluate the 
effectiveness our models, tools, and runtime infrastructures. The PI will 
supervise the students by providing advice concerning both algorithms and 
systems implementation levels.
