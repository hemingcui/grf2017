...
agree on requests. If leader fails, \paxos elects a new 
leader~\cite{paxos:practical}. To agree on an input, at least one message 
round-trip is required between the leader and a backup. A round-trip causes big 
latency (hundreds of \us) as it goes through various software layers (\eg, OS 
kernels).
